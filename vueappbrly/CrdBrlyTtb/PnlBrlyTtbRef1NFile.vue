...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyTtbRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyTtbRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyTtbRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyTtbRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyTtbRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyTtbRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyTtbRef1NFile) this.continf = dpcheng.ContInfBrlyTtbRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyTtbRef1NFile) this.statapp = dpcheng.StatAppBrlyTtbRef1NFile;
				if (dpcheng.StatShrBrlyTtbRef1NFile) this.statshr = dpcheng.StatShrBrlyTtbRef1NFile;
				if (dpcheng.StgIacBrlyTtbRef1NFile) this.stgiac = dpcheng.StgIacBrlyTtbRef1NFile;
				if (dpcheng.TagBrlyTtbRef1NFile) {
					Brly.unescapeBlock(dpcheng.TagBrlyTtbRef1NFile);
					this.tag = dpcheng.TagBrlyTtbRef1NFile;
				}
				if (dpcheng.ListBrlyQTtbRef1NFile) this.rst = dpcheng.ListBrlyQTtbRef1NFile;
				if (dpcheng.StatAppQryBrlyTtbRef1NFile) this.statappqry = dpcheng.StatAppQryBrlyTtbRef1NFile;
				if (dpcheng.StatShrQryBrlyTtbRef1NFile) this.statshrqry = dpcheng.StatShrQryBrlyTtbRef1NFile;
				if (dpcheng.StgIacQryBrlyTtbRef1NFile) this.stgiacqry = dpcheng.StgIacQryBrlyTtbRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQTtbRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyTtbRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyTtbRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
