...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyPty1NEquipment.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyPty1NEquipmentData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyPty1NEquipment": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyPty1NEquipment"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyPty1NEquipmentData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyPty1NEquipmentData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyPty1NEquipment) this.continf = dpcheng.ContInfBrlyPty1NEquipment;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyPty1NEquipment) this.statapp = dpcheng.StatAppBrlyPty1NEquipment;
				if (dpcheng.StgIacBrlyPty1NEquipment) this.stgiac = dpcheng.StgIacBrlyPty1NEquipment;
				if (dpcheng.TagBrlyPty1NEquipment) {
					Brly.unescapeBlock(dpcheng.TagBrlyPty1NEquipment);
					this.tag = dpcheng.TagBrlyPty1NEquipment;
				}
				if (dpcheng.ListBrlyQPty1NEquipment) this.rst = dpcheng.ListBrlyQPty1NEquipment;
				if (dpcheng.StatAppQryBrlyPty1NEquipment) this.statappqry = dpcheng.StatAppQryBrlyPty1NEquipment;
				if (dpcheng.StatShrQryBrlyPty1NEquipment) this.statshrqry = dpcheng.StatShrQryBrlyPty1NEquipment;
				if (dpcheng.StgIacQryBrlyPty1NEquipment) this.stgiacqry = dpcheng.StgIacQryBrlyPty1NEquipment;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQPty1NEquipment) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyPty1NEquipmentData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyPty1NEquipmentData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
