...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyConMNSegment.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyConMNSegmentData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyConMNSegment": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyConMNSegment"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyConMNSegmentData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyConMNSegmentData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyConMNSegment) this.continf = dpcheng.ContInfBrlyConMNSegment;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyConMNSegment) this.statapp = dpcheng.StatAppBrlyConMNSegment;
				if (dpcheng.StatShrBrlyConMNSegment) this.statshr = dpcheng.StatShrBrlyConMNSegment;
				if (dpcheng.StgIacBrlyConMNSegment) this.stgiac = dpcheng.StgIacBrlyConMNSegment;
				if (dpcheng.TagBrlyConMNSegment) {
					Brly.unescapeBlock(dpcheng.TagBrlyConMNSegment);
					this.tag = dpcheng.TagBrlyConMNSegment;
				}
				if (dpcheng.ListBrlyQConMNSegment) this.rst = dpcheng.ListBrlyQConMNSegment;
				if (dpcheng.StatAppQryBrlyConMNSegment) this.statappqry = dpcheng.StatAppQryBrlyConMNSegment;
				if (dpcheng.StatShrQryBrlyConMNSegment) this.statshrqry = dpcheng.StatShrQryBrlyConMNSegment;
				if (dpcheng.StgIacQryBrlyConMNSegment) this.stgiacqry = dpcheng.StgIacQryBrlyConMNSegment;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQConMNSegment) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyConMNSegmentData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyConMNSegmentData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
