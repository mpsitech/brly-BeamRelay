...
<script>
	...
	*/
	...
	export default {
		name: 'PnlBrlyLegCor1NConnection',
		...
		mounted() {
			//console.log("PnlBrlyLegCor1NConnection.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppBrlyLegCor1NConnectionDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyLegCor1NConnectionData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyLegCor1NConnection": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyLegCor1NConnection"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyLegCor1NConnectionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyLegCor1NConnectionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyLegCor1NConnection) this.continf = dpcheng.ContInfBrlyLegCor1NConnection;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyLegCor1NConnection) this.statapp = dpcheng.StatAppBrlyLegCor1NConnection;
				if (dpcheng.StatShrBrlyLegCor1NConnection) this.statshr = dpcheng.StatShrBrlyLegCor1NConnection;
				if (dpcheng.StgIacBrlyLegCor1NConnection) this.stgiac = dpcheng.StgIacBrlyLegCor1NConnection;
				if (dpcheng.TagBrlyLegCor1NConnection) {
					Brly.unescapeBlock(dpcheng.TagBrlyLegCor1NConnection);
					this.tag = dpcheng.TagBrlyLegCor1NConnection;
				}
				if (dpcheng.ListBrlyQLegCor1NConnection) this.rst = dpcheng.ListBrlyQLegCor1NConnection;
				if (dpcheng.StatAppQryBrlyLegCor1NConnection) this.statappqry = dpcheng.StatAppQryBrlyLegCor1NConnection;
				if (dpcheng.StatShrQryBrlyLegCor1NConnection) this.statshrqry = dpcheng.StatShrQryBrlyLegCor1NConnection;
				if (dpcheng.StgIacQryBrlyLegCor1NConnection) this.stgiacqry = dpcheng.StgIacQryBrlyLegCor1NConnection;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQLegCor1NConnection) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyLegCor1NConnectionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyLegCor1NConnectionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
