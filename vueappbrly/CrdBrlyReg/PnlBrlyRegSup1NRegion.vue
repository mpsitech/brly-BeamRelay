...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyRegSup1NRegion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyRegSup1NRegionData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyRegSup1NRegion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyRegSup1NRegion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyRegSup1NRegionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyRegSup1NRegionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyRegSup1NRegion) this.continf = dpcheng.ContInfBrlyRegSup1NRegion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyRegSup1NRegion) this.statapp = dpcheng.StatAppBrlyRegSup1NRegion;
				if (dpcheng.StatShrBrlyRegSup1NRegion) this.statshr = dpcheng.StatShrBrlyRegSup1NRegion;
				if (dpcheng.StgIacBrlyRegSup1NRegion) this.stgiac = dpcheng.StgIacBrlyRegSup1NRegion;
				if (dpcheng.TagBrlyRegSup1NRegion) {
					Brly.unescapeBlock(dpcheng.TagBrlyRegSup1NRegion);
					this.tag = dpcheng.TagBrlyRegSup1NRegion;
				}
				if (dpcheng.ListBrlyQRegSup1NRegion) this.rst = dpcheng.ListBrlyQRegSup1NRegion;
				if (dpcheng.StatAppQryBrlyRegSup1NRegion) this.statappqry = dpcheng.StatAppQryBrlyRegSup1NRegion;
				if (dpcheng.StatShrQryBrlyRegSup1NRegion) this.statshrqry = dpcheng.StatShrQryBrlyRegSup1NRegion;
				if (dpcheng.StgIacQryBrlyRegSup1NRegion) this.stgiacqry = dpcheng.StgIacQryBrlyRegSup1NRegion;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQRegSup1NRegion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyRegSup1NRegionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyRegSup1NRegionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
