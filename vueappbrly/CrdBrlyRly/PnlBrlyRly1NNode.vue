...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyRly1NNode.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyRly1NNodeData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyRly1NNode": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyRly1NNode"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyRly1NNodeData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyRly1NNodeData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyRly1NNode) this.continf = dpcheng.ContInfBrlyRly1NNode;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyRly1NNode) this.statapp = dpcheng.StatAppBrlyRly1NNode;
				if (dpcheng.StgIacBrlyRly1NNode) this.stgiac = dpcheng.StgIacBrlyRly1NNode;
				if (dpcheng.TagBrlyRly1NNode) {
					Brly.unescapeBlock(dpcheng.TagBrlyRly1NNode);
					this.tag = dpcheng.TagBrlyRly1NNode;
				}
				if (dpcheng.ListBrlyQRly1NNode) this.rst = dpcheng.ListBrlyQRly1NNode;
				if (dpcheng.StatAppQryBrlyRly1NNode) this.statappqry = dpcheng.StatAppQryBrlyRly1NNode;
				if (dpcheng.StatShrQryBrlyRly1NNode) this.statshrqry = dpcheng.StatShrQryBrlyRly1NNode;
				if (dpcheng.StgIacQryBrlyRly1NNode) this.stgiacqry = dpcheng.StgIacQryBrlyRly1NNode;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyRly1NNodeData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyRly1NNodeData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
