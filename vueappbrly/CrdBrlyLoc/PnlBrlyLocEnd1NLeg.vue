...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyLocEnd1NLeg.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyLocEnd1NLegData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyLocEnd1NLeg": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyLocEnd1NLeg"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyLocEnd1NLegData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyLocEnd1NLegData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyLocEnd1NLeg) this.continf = dpcheng.ContInfBrlyLocEnd1NLeg;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyLocEnd1NLeg) this.statapp = dpcheng.StatAppBrlyLocEnd1NLeg;
				if (dpcheng.StatShrBrlyLocEnd1NLeg) this.statshr = dpcheng.StatShrBrlyLocEnd1NLeg;
				if (dpcheng.StgIacBrlyLocEnd1NLeg) this.stgiac = dpcheng.StgIacBrlyLocEnd1NLeg;
				if (dpcheng.TagBrlyLocEnd1NLeg) {
					Brly.unescapeBlock(dpcheng.TagBrlyLocEnd1NLeg);
					this.tag = dpcheng.TagBrlyLocEnd1NLeg;
				}
				if (dpcheng.ListBrlyQLocEnd1NLeg) this.rst = dpcheng.ListBrlyQLocEnd1NLeg;
				if (dpcheng.StatAppQryBrlyLocEnd1NLeg) this.statappqry = dpcheng.StatAppQryBrlyLocEnd1NLeg;
				if (dpcheng.StatShrQryBrlyLocEnd1NLeg) this.statshrqry = dpcheng.StatShrQryBrlyLocEnd1NLeg;
				if (dpcheng.StgIacQryBrlyLocEnd1NLeg) this.stgiacqry = dpcheng.StgIacQryBrlyLocEnd1NLeg;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQLocEnd1NLeg) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyLocEnd1NLegData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyLocEnd1NLegData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
