...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlBrlyLocMNSegment.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppBrlyLocMNSegmentData": {
						"scrJref": this.scrJref,
						"StgIacQryBrlyLocMNSegment": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacBrlyLocMNSegment"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppBrlyLocMNSegmentData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppBrlyLocMNSegmentData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfBrlyLocMNSegment) this.continf = dpcheng.ContInfBrlyLocMNSegment;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppBrlyLocMNSegment) this.statapp = dpcheng.StatAppBrlyLocMNSegment;
				if (dpcheng.StatShrBrlyLocMNSegment) this.statshr = dpcheng.StatShrBrlyLocMNSegment;
				if (dpcheng.StgIacBrlyLocMNSegment) this.stgiac = dpcheng.StgIacBrlyLocMNSegment;
				if (dpcheng.TagBrlyLocMNSegment) {
					Brly.unescapeBlock(dpcheng.TagBrlyLocMNSegment);
					this.tag = dpcheng.TagBrlyLocMNSegment;
				}
				if (dpcheng.ListBrlyQLocMNSegment) this.rst = dpcheng.ListBrlyQLocMNSegment;
				if (dpcheng.StatAppQryBrlyLocMNSegment) this.statappqry = dpcheng.StatAppQryBrlyLocMNSegment;
				if (dpcheng.StatShrQryBrlyLocMNSegment) this.statshrqry = dpcheng.StatShrQryBrlyLocMNSegment;
				if (dpcheng.StgIacQryBrlyLocMNSegment) this.stgiacqry = dpcheng.StgIacQryBrlyLocMNSegment;
				/*
				...
				*/
				...
				if (dpcheng.ListBrlyQLocMNSegment) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxBrlyVDpch, dpcheng) {
				if (srefIxBrlyVDpch == "DpchEngBrlyLocMNSegmentData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxBrlyVDpch == "DpchEngBrlyLocMNSegmentData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
