...
function getMenAvail(short) {
	return(retrieveSi(srcdoc, "StatShrBrlyUsgHeadbar", "Men" + short + "Avail") == "true");
};

function getMenCptwidth(short) {
	return(parseInt(retrieveSi(srcdoc, "StgInfBrlyUsgHeadbar", "Men" + short + "Cptwidth")));
};
...
function handleMenAppClick() {
	getCrdwnd().toggleMenu("App", getMenLeft("App"), parseInt(retrieveSi(srcdoc, "StgInfBrlyUsgHeadbar", "MenAppWidth")), 42);
};

function handleMenCrdClick() {
	getCrdwnd().toggleMenu("Crd", getMenLeft("Crd"), parseInt(retrieveSi(srcdoc, "StgInfBrlyUsgHeadbar", "MenCrdWidth")), 22);
};
