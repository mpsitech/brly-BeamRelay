...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		var TcoFegWidth = parseInt(retrieveSi(srcdoc, "StgIacBrlyUsrAAccess", "TcoFegWidth"));
		var TcoFeaWidth = parseInt(retrieveSi(srcdoc, "StgIacBrlyUsrAAccess", "TcoFeaWidth"));
		var TcoAccWidth = parseInt(retrieveSi(srcdoc, "StgIacBrlyUsrAAccess", "TcoAccWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyUsrAAccess", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyUsrAAccess", "ListBrlyQUsrAAccess", retrieveTi(srcdoc, "TagBrlyUsrAAccess", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyUsrAAccess", "TxtRecord2"),
				["Feg","","Fea","Acc",""],
