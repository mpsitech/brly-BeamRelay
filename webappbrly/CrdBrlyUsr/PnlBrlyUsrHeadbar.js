...
function getMenAvail(short) {
	return(retrieveSi(srcdoc, "StatShrBrlyUsrHeadbar", "Men" + short + "Avail") == "true");
};

function getMenCptwidth(short) {
	return(parseInt(retrieveSi(srcdoc, "StgInfBrlyUsrHeadbar", "Men" + short + "Cptwidth")));
};
...
function handleMenAppClick() {
	getCrdwnd().toggleMenu("App", getMenLeft("App"), parseInt(retrieveSi(srcdoc, "StgInfBrlyUsrHeadbar", "MenAppWidth")), 42);
};

function handleMenCrdClick() {
	getCrdwnd().toggleMenu("Crd", getMenLeft("Crd"), parseInt(retrieveSi(srcdoc, "StgInfBrlyUsrHeadbar", "MenCrdWidth")), 22);
};
