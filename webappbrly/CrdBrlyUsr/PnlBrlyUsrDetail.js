...
function initBD(bNotD) {
	...
	initCpt(contcontdoc, "CptFky", retrieveTi(srcdoc, "TagBrlyUsrDetail", "CptFky"));
	initCpt(contcontdoc, "CptCmt", retrieveTi(srcdoc, "TagBrlyUsrDetail", "CptCmt"));
	// IP initBD --- END
...
function refreshBD(bNotD) {
	...
	var TxfFkyActive = (retrieveSi(srcdoc, "StatShrBrlyUsrDetail", "TxfFkyActive") == "true");

	var TxfCmtActive = (retrieveSi(srcdoc, "StatShrBrlyUsrDetail", "TxfCmtActive") == "true");
	...
	refreshTxft(contcontdoc, "TxfFky", retrieveCi(srcdoc, "ContIacBrlyUsrDetail", "TxfFky"), TxfFkyActive, false, true);

	refreshTxft(contcontdoc, "TxfCmt", retrieveCi(srcdoc, "ContIacBrlyUsrDetail", "TxfCmt"), TxfCmtActive, false, true);
...
function handleTxftChange(_doc, ctlsref) {
	...
	setCi(srcdoc, "ContIacBrlyUsrDetail", ctlsref, elem.value.replace(/\n/g, ";"));
