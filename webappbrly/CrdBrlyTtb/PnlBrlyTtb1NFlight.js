...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyTtb1NFlight", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyTtb1NFlight", "ListBrlyQTtb1NFlight", retrieveTi(srcdoc, "TagBrlyTtb1NFlight", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyTtb1NFlight", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
