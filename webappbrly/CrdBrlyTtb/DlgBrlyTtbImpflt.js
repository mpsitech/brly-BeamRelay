...
function refreshLfi() {
	...
	// IP refreshLfi --- BEGIN
	refreshDld(contdoc, "Dld", scrJref, retrieveCi(srcdoc, "ContInfDlgBrlyTtbImpfltLfi", "Dld"), DldActive);
...
function refresh(updDit, updHdr) {
	...
	var initdone = (retrieveSi(srcdoc, "StatAppDlgBrlyTtbImpflt", "initdone") == "true");
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngDlgBrlyTtbImpfltData", "ContInfDlgBrlyTtbImpfltLfi", srcdoc)) mask.push("continflfi");
