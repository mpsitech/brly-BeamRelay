...
function refreshTfi() {
	...
	// IP refreshTfi --- BEGIN
	refreshDld(contdoc, "Dld", scrJref, retrieveCi(srcdoc, "ContInfDlgBrlyTtbTrlorigTfi", "Dld"), DldActive);
...
function refresh(updDit, updHdr) {
	...
	var initdone = (retrieveSi(srcdoc, "StatAppDlgBrlyTtbTrlorig", "initdone") == "true");
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngDlgBrlyTtbTrlorigData", "ContInfDlgBrlyTtbTrlorigTfi", srcdoc)) mask.push("continftfi");
