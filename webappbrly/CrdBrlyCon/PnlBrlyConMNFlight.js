...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyConMNFlight", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyConMNFlight", "ListBrlyQConMNFlight", retrieveTi(srcdoc, "TagBrlyConMNFlight", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyConMNFlight", "TxtRecord2"),
