...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyConMNSegment", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyConMNSegment", "ListBrlyQConMNSegment", retrieveTi(srcdoc, "TagBrlyConMNSegment", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyConMNSegment", "TxtRecord2"),
