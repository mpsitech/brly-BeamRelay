...
function getMenAvail(short) {
	return(retrieveSi(srcdoc, "StatShrBrlyConHeadbar", "Men" + short + "Avail") == "true");
};

function getMenCptwidth(short) {
	return(parseInt(retrieveSi(srcdoc, "StgInfBrlyConHeadbar", "Men" + short + "Cptwidth")));
};
...
function handleMenAppClick() {
	getCrdwnd().toggleMenu("App", getMenLeft("App"), parseInt(retrieveSi(srcdoc, "StgInfBrlyConHeadbar", "MenAppWidth")), 42);
};

function handleMenCrdClick() {
	getCrdwnd().toggleMenu("Crd", getMenLeft("Crd"), parseInt(retrieveSi(srcdoc, "StgInfBrlyConHeadbar", "MenCrdWidth")), 43);
};
