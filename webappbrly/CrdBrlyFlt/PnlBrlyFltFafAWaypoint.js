...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyFltFafAWaypoint", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyFltFafAWaypoint", "ListBrlyQFltFafAWaypoint", retrieveTi(srcdoc, "TagBrlyFltFafAWaypoint", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyFltFafAWaypoint", "TxtRecord2"),
