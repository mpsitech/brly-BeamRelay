...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyFltOrgMNFlight", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyFltOrgMNFlight", "ListBrlyQFltOrgMNFlight", retrieveTi(srcdoc, "TagBrlyFltOrgMNFlight", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyFltOrgMNFlight", "TxtRecord2"),
