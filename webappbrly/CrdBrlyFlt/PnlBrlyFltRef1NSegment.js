...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyFltRef1NSegment", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyFltRef1NSegment", "ListBrlyQFltRef1NSegment", retrieveTi(srcdoc, "TagBrlyFltRef1NSegment", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyFltRef1NSegment", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
