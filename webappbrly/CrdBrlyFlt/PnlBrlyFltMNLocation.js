...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyFltMNLocation", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyFltMNLocation", "ListBrlyQFltMNLocation", retrieveTi(srcdoc, "TagBrlyFltMNLocation", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyFltMNLocation", "TxtRecord2"),
