...
function updateHeight() {
	...
	heightRhs = height1NFlight+13 + heightCor1NConnection+13 + heightMNLocation+13 + heightOrgMNLeg+13 + 5;
	...
	if (_scrJref == scrJref) {
		...
		if (srefIxBrlyVExpstate != "mind") {
			...
			if (_scrJref == scrJrefPre) {
				...
				if (getInitdone("1NFlight")) rhsdoc.getElementById("1NFlight").contentWindow.handleDpchEng(dom, dpch);
			} else if (_scrJref == scrJrefCor1NConnection) {
				if (getInitdone("Cor1NConnection")) rhsdoc.getElementById("Cor1NConnection").contentWindow.handleDpchEng(dom, dpch);
				...
				if (getInitdone("OrgMNLeg")) rhsdoc.getElementById("OrgMNLeg").contentWindow.handleDpchEng(dom, dpch);
			} else {
