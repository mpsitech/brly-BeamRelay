...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyLegOrgMNLeg", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyLegOrgMNLeg", "ListBrlyQLegOrgMNLeg", retrieveTi(srcdoc, "TagBrlyLegOrgMNLeg", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyLegOrgMNLeg", "TxtRecord2"),
