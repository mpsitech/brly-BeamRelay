...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyLegMNLocation", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyLegMNLocation", "ListBrlyQLegMNLocation", retrieveTi(srcdoc, "TagBrlyLegMNLocation", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyLegMNLocation", "TxtRecord2"),
