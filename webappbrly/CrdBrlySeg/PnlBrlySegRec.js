...
function updateHeight() {
	...
	heightRhs = heightOrgMNSegment+13 + heightMNLocation+13 + heightMNConnection+13 + 5;
	...
	if (_scrJref == scrJref) {
		...
		if (srefIxBrlyVExpstate != "mind") {
			...
			if (_scrJref == scrJrefPre) {
				...
				if (getInitdone("OrgMNSegment")) rhsdoc.getElementById("OrgMNSegment").contentWindow.handleDpchEng(dom, dpch);
