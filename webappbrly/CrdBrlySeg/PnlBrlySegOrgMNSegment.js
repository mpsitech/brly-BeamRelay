...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlySegOrgMNSegment", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlySegOrgMNSegment", "ListBrlyQSegOrgMNSegment", retrieveTi(srcdoc, "TagBrlySegOrgMNSegment", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlySegOrgMNSegment", "TxtRecord2"),
