...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlySegMNLocation", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlySegMNLocation", "ListBrlyQSegMNLocation", retrieveTi(srcdoc, "TagBrlySegMNLocation", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlySegMNLocation", "TxtRecord2"),
