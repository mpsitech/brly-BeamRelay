...
function refreshB(chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			setTextContent(tbldoc, myspan, retrieveTi(srcdoc, "TagBrlySegList", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlySegList", "ListBrlyQSegList", retrieveTi(srcdoc, "TagBrlySegList", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlySegList", "TxtRecord2"),
				["","Ret","Reu","Al0","Al1","Th0","Th1","Ph0","Ph1","Sta","Sto"],
				["ret","ret2","reu","al0","al1","th0","th1","ph0","ph1","sta","sto"]);
};
