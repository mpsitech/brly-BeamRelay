...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyLocMNSegment", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyLocMNSegment", "ListBrlyQLocMNSegment", retrieveTi(srcdoc, "TagBrlyLocMNSegment", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyLocMNSegment", "TxtRecord2"),
