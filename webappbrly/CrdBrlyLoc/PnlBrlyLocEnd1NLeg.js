...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyLocEnd1NLeg", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyLocEnd1NLeg", "ListBrlyQLocEnd1NLeg", retrieveTi(srcdoc, "TagBrlyLocEnd1NLeg", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyLocEnd1NLeg", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
