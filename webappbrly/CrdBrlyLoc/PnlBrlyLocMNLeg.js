...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyLocMNLeg", doc.cols[j]));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "BrlyLocMNLeg", "ListBrlyQLocMNLeg", retrieveTi(srcdoc, "TagBrlyLocMNLeg", "TxtRecord1"), retrieveTi(srcdoc, "TagBrlyLocMNLeg", "TxtRecord2"),
