...
function initMenApp() {
	...
	MspApp2Avail = (retrieveSi(srcdoc, "StatShrBrlyNav", "MspApp2Avail") == "true");
	MitAppLoiAvail = (retrieveSi(srcdoc, "StatShrBrlyNav", "MitAppLoiAvail") == "true");
...
function initMenSes() {
	...
	MitSesSpsAvail = (retrieveSi(srcdoc, "StatShrBrlyNav", "MitSesSpsAvail") == "true");
	...
	setTextContent(mendoc, mendoc.getElementById("MitSesSps"), retrieveTi(srcdoc, "TagBrlyNav", "MitSesSps"));
...
function initMenCrd() {
	...
	MitCrdSegAvail = (retrieveSi(srcdoc, "StatShrBrlyNav", "MitCrdSegAvail") == "true");
	...
	MitCrdRlyAvail = (retrieveSi(srcdoc, "StatShrBrlyNav", "MitCrdRlyAvail") == "true");
	...
	setTextContent(mendoc, mendoc.getElementById("MitCrdSeg"), retrieveTi(srcdoc, "TagBrlyNav", "MitCrdSeg"));
	setTextContent(mendoc, mendoc.getElementById("MitCrdCon"), retrieveTi(srcdoc, "TagBrlyNav", "MitCrdCon"));
	setTextContent(mendoc, mendoc.getElementById("MitCrdRly"), retrieveTi(srcdoc, "TagBrlyNav", "MitCrdRly"));
	...
	height -= setMitMspAvail("MitCrdRly", MitCrdRlyAvail, 20);
...
function handleDpchEngSub(_scrJref, dom, dpch) {
	if (_scrJref == scrJrefPnld) {
		...
		doc.getElementById("Base").contentWindow.handleDpchEng(dom, dpch);
	} else if (_scrJref == scrJrefConnect) {
		doc.getElementById("Connect").contentWindow.handleDpchEng(dom, dpch);
