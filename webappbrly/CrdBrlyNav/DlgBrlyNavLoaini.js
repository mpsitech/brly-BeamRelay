...
function refreshLfi() {
	...
	// IP refreshLfi --- BEGIN
	refreshDld(contdoc, "Dld", scrJref, retrieveCi(srcdoc, "ContInfDlgBrlyNavLoainiLfi", "Dld"), DldActive);
...
function refresh(updDit, updHdr) {
	...
	var initdone = (retrieveSi(srcdoc, "StatAppDlgBrlyNavLoaini", "initdone") == "true");
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngDlgBrlyNavLoainiData", "ContInfDlgBrlyNavLoainiLfi", srcdoc)) mask.push("continflfi");
