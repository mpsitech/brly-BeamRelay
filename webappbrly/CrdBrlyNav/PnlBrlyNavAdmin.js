...
function refreshBD(bNotD) {
	...
	height -= setCtlAvail(contcontdoc, "Opr2", LstOprAvail && !LstOprAlt, (LstOprAvail) ? 71 : 0);
	if (LstOprAvail) {
	...
	height -= setCtlAvail(contcontdoc, "Pty2", LstPtyAvail && !LstPtyAlt, (LstPtyAvail) ? 71 : 0);
	if (LstPtyAvail) {
...
function handleLstSelect(ctlsref, multsel, num) {
	...
	if (multsel) {
		...
		setCi(srcdoc, "ContIacBrlyNavAdmin", "numsF" + ctlsref, encodeUintvec(numsFLst));
