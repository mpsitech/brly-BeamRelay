...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQPrsADetail* rst = NULL, QryBrlyPrsADetail::StatShr* statshrqry = NULL, QryBrlyPrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
