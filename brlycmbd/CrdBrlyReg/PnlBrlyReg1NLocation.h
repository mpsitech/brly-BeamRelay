...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQReg1NLocation* rst = NULL, QryBrlyReg1NLocation::StatShr* statshrqry = NULL, QryBrlyReg1NLocation::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
