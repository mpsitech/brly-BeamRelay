...
public:
	...
	public:
		static const Sbecore::uint TCOSTDWIDTH = 1;
		static const Sbecore::uint TCOSTTWIDTH = 2;

	public:
		StgIac(const Sbecore::uint TcoStdWidth = 100, const Sbecore::uint TcoSttWidth = 100);

	public:
		Sbecore::uint TcoStdWidth;
		Sbecore::uint TcoSttWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQRegADstswitch* rst = NULL, QryBrlyRegADstswitch::StatShr* statshrqry = NULL, QryBrlyRegADstswitch::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyRegADstswitch(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyRegADstswitch();
