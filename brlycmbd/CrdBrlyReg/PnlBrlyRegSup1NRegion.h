...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQRegSup1NRegion* rst = NULL, QryBrlyRegSup1NRegion::StatShr* statshrqry = NULL, QryBrlyRegSup1NRegion::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
