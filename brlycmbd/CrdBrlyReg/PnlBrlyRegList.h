...
public:
	...
	public:
		...
		static const Sbecore::uint TCODSTWIDTH = 4;
		static const Sbecore::uint TCOTOFWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 175, const Sbecore::uint TcoSupWidth = 100, const Sbecore::uint TcoDstWidth = 100, const Sbecore::uint TcoTofWidth = 100);

	public:
		Sbecore::uint TcoSrfWidth;
		Sbecore::uint TcoTitWidth;
		Sbecore::uint TcoSupWidth;
		Sbecore::uint TcoDstWidth;
		Sbecore::uint TcoTofWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQRegList* rst = NULL, QryBrlyRegList::StatShr* statshrqry = NULL, QryBrlyRegList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyRegList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyRegList();
