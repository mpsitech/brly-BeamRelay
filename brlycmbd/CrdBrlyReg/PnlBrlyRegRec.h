...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneADstswitch = false, const bool initdone1NLocation = false, const bool initdoneSup1NRegion = false);
