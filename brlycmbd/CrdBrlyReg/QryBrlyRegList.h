...
public:
	QryBrlyRegList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyRegList();
...
public:
	...
	BrlyQRegList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallBrlyRegMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
