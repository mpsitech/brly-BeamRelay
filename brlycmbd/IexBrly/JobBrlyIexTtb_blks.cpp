/**
	* \file JobBrlyIexTtb_blks.cpp
	* job handler for job JobBrlyIexTtb (implementation of blocks)
...
/******************************************************************************
 class JobBrlyIexTtb::VecVSge
 ******************************************************************************/

uint JobBrlyIexTtb::VecVSge::getIx(
			const string& sref
		) {
...
string JobBrlyIexTtb::VecVSge::getSref(
			const uint ix
		) {
...
void JobBrlyIexTtb::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
