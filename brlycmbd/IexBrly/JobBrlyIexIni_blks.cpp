/**
	* \file JobBrlyIexIni_blks.cpp
	* job handler for job JobBrlyIexIni (implementation of blocks)
...
/******************************************************************************
 class JobBrlyIexIni::VecVSge
 ******************************************************************************/

uint JobBrlyIexIni::VecVSge::getIx(
			const string& sref
		) {
...
string JobBrlyIexIni::VecVSge::getSref(
			const uint ix
		) {
...
void JobBrlyIexIni::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
