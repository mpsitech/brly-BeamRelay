...
public:
	QryBrlyUsgMNUser(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyUsgMNUser();
...
public:
	...
	BrlyQUsgMNUser* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyUsrRusgMod_usgEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
