...
CrdBrlyUsg::CrdBrlyUsg(
	...
	if ((ref + 1) != 0) xchg->triggerIxRefCall(dbsbrly, VecBrlyVCall::CALLBRLYREFPRESET, jref, VecBrlyVPreset::PREBRLYREFUSG, ref);
...
void CrdBrlyUsg::changeRef(
	...
	xchg->triggerIxRefToIxCall(dbsbrly, VecBrlyVCall::CALLBRLYRECACCESS, jref, VecBrlyVCard::CRDBRLYUSG, ref, ixBrlyVRecaccess);
