...
public:
	PnlBrlyUsgDetail(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyUsgDetail();
...
public:
	...
	void refreshRecUsg(DbsBrly* dbsbrly, std::set<Sbecore::uint>& moditems);
