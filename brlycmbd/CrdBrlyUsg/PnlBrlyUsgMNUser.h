...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 200, const Sbecore::uint TcoUlvWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQUsgMNUser* rst = NULL, QryBrlyUsgMNUser::StatShr* statshrqry = NULL, QryBrlyUsgMNUser::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyUsgMNUser(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyUsgMNUser();
