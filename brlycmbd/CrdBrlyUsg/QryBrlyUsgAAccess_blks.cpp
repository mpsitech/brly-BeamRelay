...
void QryBrlyUsgAAccess::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
...
void QryBrlyUsgAAccess::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryBrlyUsgAAccess::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryBrlyUsgAAccess"];}();
...
void QryBrlyUsgAAccess::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
