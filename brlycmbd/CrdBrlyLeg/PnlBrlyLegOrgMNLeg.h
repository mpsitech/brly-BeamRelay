...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLegOrgMNLeg* rst = NULL, QryBrlyLegOrgMNLeg::StatShr* statshrqry = NULL, QryBrlyLegOrgMNLeg::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
