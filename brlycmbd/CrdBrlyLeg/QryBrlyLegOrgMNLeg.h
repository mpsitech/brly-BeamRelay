...
public:
	QryBrlyLegOrgMNLeg(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLegOrgMNLeg();
...
public:
	...
	BrlyQLegOrgMNLeg* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyLegRlegMod_olgEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
