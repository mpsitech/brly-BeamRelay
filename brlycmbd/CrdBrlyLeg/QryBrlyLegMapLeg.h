...
public:
	QryBrlyLegMapLeg(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLegMapLeg();
...
public:
	...
	BrlyQLegMapLeg* getRecByJnum(const Sbecore::uint jnum);
