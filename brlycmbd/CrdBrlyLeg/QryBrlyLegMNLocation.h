...
public:
	QryBrlyLegMNLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLegMNLocation();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const double prePhi, const bool addwhere);
	...
	BrlyQLegMNLocation* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyLegRlocMod_legEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
