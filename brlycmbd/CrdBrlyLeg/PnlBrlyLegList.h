...
public:
	...
	public:
		...
		static const Sbecore::uint TCOBLOWIDTH = 3;
		static const Sbecore::uint TCOELOWIDTH = 4;
		static const Sbecore::uint TCOTYPWIDTH = 5;
		static const Sbecore::uint TCOALTWIDTH = 6;

	public:
		StgIac(const Sbecore::uint TcoGrpWidth = 100, const Sbecore::uint TcoOwnWidth = 100, const Sbecore::uint TcoBloWidth = 175, const Sbecore::uint TcoEloWidth = 175, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoAltWidth = 100);

	public:
		Sbecore::uint TcoGrpWidth;
		Sbecore::uint TcoOwnWidth;
		Sbecore::uint TcoBloWidth;
		Sbecore::uint TcoEloWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLegList* rst = NULL, QryBrlyLegList::StatShr* statshrqry = NULL, QryBrlyLegList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyLegList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyLegList();
