...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdonePre = false, const bool initdoneDetail = false, const bool initdoneMap = false, const bool initdone1NFlight = false, const bool initdoneCor1NConnection = false, const bool initdoneMNLocation = false, const bool initdoneOrgMNLeg = false);
