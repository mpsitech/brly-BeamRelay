...
public:
	...
	public:
		...
		static const Sbecore::uint ELO = 2;
		static const Sbecore::uint BLO = 3;
...
public:
	QryBrlyLegList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLegList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const Sbecore::ubigint preGrp, const Sbecore::ubigint preOwn, const Sbecore::ubigint preBlo, const Sbecore::ubigint preElo, const Sbecore::uint preTyp, const bool addwhere);
	...
	BrlyQLegList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyLegMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
