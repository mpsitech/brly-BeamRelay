...
public:
	...
	public:
		static const Sbecore::uint TCOSTAWIDTH = 1;
		static const Sbecore::uint TCOSTOWIDTH = 2;
		static const Sbecore::uint TCOCONWIDTH = 3;
		static const Sbecore::uint TCODIRWIDTH = 4;
		static const Sbecore::uint TCOCTDWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoStaWidth = 100, const Sbecore::uint TcoStoWidth = 100, const Sbecore::uint TcoConWidth = 100, const Sbecore::uint TcoDirWidth = 100, const Sbecore::uint TcoCtdWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQRlyList* rst = NULL, QryBrlyRlyList::StatShr* statshrqry = NULL, QryBrlyRlyList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyRlyList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyRlyList();
