...
public:
	QryBrlyPtyList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyPtyList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const std::string& preTit, const bool addwhere);
	...
	BrlyQPtyList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyPtyMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
