...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListBrlyQPty1NEquipment* rst = NULL, QryBrlyPty1NEquipment::StatShr* statshrqry = NULL, QryBrlyPty1NEquipment::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
