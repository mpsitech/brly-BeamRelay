...
public:
	QryBrlyPty1NEquipment(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyPty1NEquipment();
...
public:
	...
	BrlyQPty1NEquipment* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyEqpMod_ptyEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
