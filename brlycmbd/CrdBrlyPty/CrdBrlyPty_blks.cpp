...
void CrdBrlyPty::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdBrlyPty::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void CrdBrlyPty::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
CrdBrlyPty::DpchAppDo::DpchAppDo() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYPTYDO)
		{
	ixVDo = 0;
};
...
void CrdBrlyPty::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyPtyDo"];}();
...
void CrdBrlyPty::DpchEngData::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngBrlyPtyData"] = Json::Value(Json::objectValue);
