...
void PnlBrlyFltMNConnection::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyFltMNConnection::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlBrlyFltMNConnection::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlBrlyFltMNConnection::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacBrlyFltMNConnection"];}();
...
void PnlBrlyFltMNConnection::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyFltMNConnection::Tag::writeJSON(
	...
	if (ixBrlyVLocale == VecBrlyVLocale::ENUS) {
		me["Cpt"] = "Availability for connections";
		...
		me["Cpt"] = "Verf\\u00fcgbarkeit f\\u00fcr Verbindungen";
...
PnlBrlyFltMNConnection::DpchAppData::DpchAppData() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFLTMNCONNECTIONDATA)
		{
};
...
void PnlBrlyFltMNConnection::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyFltMNConnectionData"];}();
...
PnlBrlyFltMNConnection::DpchAppDo::DpchAppDo() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFLTMNCONNECTIONDO)
		{
	ixVDo = 0;
};
...
void PnlBrlyFltMNConnection::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyFltMNConnectionDo"];}();
...
void PnlBrlyFltMNConnection::DpchEngData::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngBrlyFltMNConnectionData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryBrlyFltMNConnection::StatApp::writeJSON(me);
