...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListBrlyQFltEqp1NNode* rst = NULL, QryBrlyFltEqp1NNode::StatShr* statshrqry = NULL, QryBrlyFltEqp1NNode::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
