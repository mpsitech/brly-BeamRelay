...
void QryBrlyFlt1NConnection::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
...
void QryBrlyFlt1NConnection::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryBrlyFlt1NConnection::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryBrlyFlt1NConnection"];}();
...
void QryBrlyFlt1NConnection::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
