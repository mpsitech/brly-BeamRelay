...
public:
	QryBrlyFltOrgMNFlight(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyFltOrgMNFlight();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const int preTime, const bool addwhere);
	...
	BrlyQFltOrgMNFlight* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyFltRfltMod_oflEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
