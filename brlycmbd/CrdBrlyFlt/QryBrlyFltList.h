...
public:
	...
	public:
		...
		static const Sbecore::uint LEG = 3;
		static const Sbecore::uint SRF = 4;
		static const Sbecore::uint EQP = 5;
...
public:
	QryBrlyFltList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyFltList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preEqp, const Sbecore::ubigint preLeg, const int preSta, const int preSto, const bool addwhere);
	...
	BrlyQFltList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyFltMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
