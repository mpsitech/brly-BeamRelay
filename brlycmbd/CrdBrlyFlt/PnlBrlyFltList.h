...
public:
	...
	public:
		...
		static const Sbecore::uint TCOEQPWIDTH = 2;
		static const Sbecore::uint TCOLEGWIDTH = 3;
		static const Sbecore::uint TCOSTAWIDTH = 4;
		static const Sbecore::uint TCOSTOWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 150, const Sbecore::uint TcoEqpWidth = 100, const Sbecore::uint TcoLegWidth = 250, const Sbecore::uint TcoStaWidth = 175, const Sbecore::uint TcoStoWidth = 175);

	public:
		Sbecore::uint TcoSrfWidth;
		Sbecore::uint TcoEqpWidth;
		Sbecore::uint TcoLegWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQFltList* rst = NULL, QryBrlyFltList::StatShr* statshrqry = NULL, QryBrlyFltList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyFltList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyFltList();
