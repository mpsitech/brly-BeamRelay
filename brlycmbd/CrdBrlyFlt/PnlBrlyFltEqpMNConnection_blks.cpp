...
void PnlBrlyFltEqpMNConnection::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyFltEqpMNConnection::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlBrlyFltEqpMNConnection::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlBrlyFltEqpMNConnection::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacBrlyFltEqpMNConnection"];}();
...
void PnlBrlyFltEqpMNConnection::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyFltEqpMNConnection::Tag::writeJSON(
...
PnlBrlyFltEqpMNConnection::DpchAppData::DpchAppData() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFLTEQPMNCONNECTIONDATA)
		{
};
...
void PnlBrlyFltEqpMNConnection::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyFltEqpMNConnectionData"];}();
...
PnlBrlyFltEqpMNConnection::DpchAppDo::DpchAppDo() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFLTEQPMNCONNECTIONDO)
		{
	ixVDo = 0;
};
...
void PnlBrlyFltEqpMNConnection::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyFltEqpMNConnectionDo"];}();
...
void PnlBrlyFltEqpMNConnection::DpchEngData::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngBrlyFltEqpMNConnectionData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryBrlyFltEqpMNConnection::StatApp::writeJSON(me);
