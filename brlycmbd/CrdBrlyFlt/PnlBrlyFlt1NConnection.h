...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQFlt1NConnection* rst = NULL, QryBrlyFlt1NConnection::StatShr* statshrqry = NULL, QryBrlyFlt1NConnection::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
