...
public:
	QryBrlyFltMNLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyFltMNLocation();
...
public:
	...
	BrlyQFltMNLocation* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyFltRlocMod_fltEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
