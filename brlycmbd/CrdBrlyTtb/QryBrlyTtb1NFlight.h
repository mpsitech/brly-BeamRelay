...
public:
	QryBrlyTtb1NFlight(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyTtb1NFlight();
...
public:
	...
	BrlyQTtb1NFlight* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyFltMod_ttbEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
