...
public:
	QryBrlyTtbList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyTtbList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preTit, const Sbecore::ubigint preFil, const bool addwhere);
	...
	BrlyQTtbList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyTtbMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
