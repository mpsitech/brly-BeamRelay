...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQTtbRef1NFile* rst = NULL, QryBrlyTtbRef1NFile::StatShr* statshrqry = NULL, QryBrlyTtbRef1NFile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
