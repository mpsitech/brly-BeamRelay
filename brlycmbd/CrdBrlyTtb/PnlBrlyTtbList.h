...
public:
	...
	public:
		...
		static const Sbecore::uint TCOFILWIDTH = 2;
		static const Sbecore::uint TCOALIWIDTH = 3;
		static const Sbecore::uint TCOSTAWIDTH = 4;
		static const Sbecore::uint TCOSTOWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoTitWidth = 200, const Sbecore::uint TcoFilWidth = 200, const Sbecore::uint TcoAliWidth = 100, const Sbecore::uint TcoStaWidth = 100, const Sbecore::uint TcoStoWidth = 100);

	public:
		Sbecore::uint TcoTitWidth;
		Sbecore::uint TcoFilWidth;
		Sbecore::uint TcoAliWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQTtbList* rst = NULL, QryBrlyTtbList::StatShr* statshrqry = NULL, QryBrlyTtbList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyTtbList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyTtbList();
