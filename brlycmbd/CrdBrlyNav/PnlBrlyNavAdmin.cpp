...
PnlBrlyNavAdmin::PnlBrlyNavAdmin(
	...
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYUSG, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYUSR, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYPRS, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYFIL, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYOPR, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYPTY, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
};
...
void PnlBrlyNavAdmin::refreshUsg(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYUSG, false, rst);
...
void PnlBrlyNavAdmin::refreshUsr(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYUSR, false, rst);
...
void PnlBrlyNavAdmin::refreshPrs(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYPRS, false, rst);
...
void PnlBrlyNavAdmin::refreshFil(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYFIL, false, rst);
...
void PnlBrlyNavAdmin::refreshOpr(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYOPR, false, rst);
...
void PnlBrlyNavAdmin::refreshPty(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYPTY, false, rst);
