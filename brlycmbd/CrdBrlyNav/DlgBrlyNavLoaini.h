...
#define ContInfDlgBrlyNavLoainiLfi DlgBrlyNavLoaini::ContInfLfi
...
public:
	...
	/**
	  * ContInfLfi (full: ContInfDlgBrlyNavLoainiLfi)
	  */
...
public:
	DlgBrlyNavLoaini(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~DlgBrlyNavLoaini();
...
private:
	...
	std::string handleDownloadInSgeDone(DbsBrly* dbsbrly);
