...
PnlBrlyNavBase::PnlBrlyNavBase(
	...
	xchg->addClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, Arg(), 0, Clstn::VecVJactype::LOCK);

	// IP constructor.cust3 --- INSERT

	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYREG, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYLOC, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYLEG, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYTTB, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYFLT, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYHUSRRUNVMOD_CRDUSREQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVCard::CRDBRLYSEG, xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref));
};
...
void PnlBrlyNavBase::refreshReg(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYREG, false, rst);
...
void PnlBrlyNavBase::refreshLoc(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYLOC, false, rst);
...
void PnlBrlyNavBase::refreshLeg(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYLEG, false, rst);
...
void PnlBrlyNavBase::refreshTtb(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYTTB, false, rst);
...
void PnlBrlyNavBase::refreshFlt(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYFLT, false, rst);
...
void PnlBrlyNavBase::refreshSeg(
	...
	dbsbrly->tblbrlyhistrmuseruniversal->loadRstByUsrCrd(xchg->getRefPreset(VecBrlyVPreset::PREBRLYOWNER, jref), VecBrlyVCard::CRDBRLYSEG, false, rst);
		...
		if (req->dpchapp->ixBrlyVDpch == VecBrlyVDpch::DPCHAPPBRLYINIT) {
			...
			if (dpchappdo->ixVDo != 0) {
				if (dpchappdo->ixVDo == VecVDo::BUTREGVIEWCLICK) {
					...
					handleDpchAppDoButSegNewcrdClick(dbsbrly, &(req->dpcheng));
				};
...
void PnlBrlyNavBase::handleDpchAppDoButSegNewcrdClick(
			DbsBrly* dbsbrly
			, DpchEngBrly** dpcheng
		) {
	ubigint jrefNew = 0;
