...
public:
	QryBrlyUsrList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyUsrList();
...
public:
	...
	BrlyQUsrList* getRecByJnum(const Sbecore::uint jnum);
