...
public:
	QryBrlyUsrAAccess(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyUsrAAccess();
...
public:
	...
	BrlyQUsrAAccess* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyUsrAaccMod_usrEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
