...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQUsrAAccess* rst = NULL, QryBrlyUsrAAccess::StatShr* statshrqry = NULL, QryBrlyUsrAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
