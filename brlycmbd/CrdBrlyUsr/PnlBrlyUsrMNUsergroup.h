...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQUsrMNUsergroup* rst = NULL, QryBrlyUsrMNUsergroup::StatShr* statshrqry = NULL, QryBrlyUsrMNUsergroup::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
