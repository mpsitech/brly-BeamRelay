...
public:
	QryBrlyUsrMNUsergroup(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyUsrMNUsergroup();
...
public:
	...
	BrlyQUsrMNUsergroup* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyUsrRusgMod_usrEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
