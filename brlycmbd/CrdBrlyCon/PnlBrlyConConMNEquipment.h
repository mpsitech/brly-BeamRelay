...
public:
	...
	public:
		...
		static const Sbecore::uint BUTADDCLICK = 4;
		static const Sbecore::uint BUTSUBCLICK = 5;
	...
	public:
		...
		static const Sbecore::uint BUTADDAVAIL = 7;
		static const Sbecore::uint BUTSUBAVAIL = 8;
		static const Sbecore::uint BUTSUBACTIVE = 9;
	...
	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 250);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQConConMNEquipment* rst = NULL, QryBrlyConConMNEquipment::StatShr* statshrqry = NULL, QryBrlyConConMNEquipment::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyConConMNEquipment(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyConConMNEquipment();
