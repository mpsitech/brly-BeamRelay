...
void PnlBrlyConMNFlight::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyConMNFlight::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlBrlyConMNFlight::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlBrlyConMNFlight::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacBrlyConMNFlight"];}();
...
void PnlBrlyConMNFlight::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyConMNFlight::Tag::writeJSON(
...
PnlBrlyConMNFlight::DpchAppData::DpchAppData() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYCONMNFLIGHTDATA)
		{
};
...
void PnlBrlyConMNFlight::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyConMNFlightData"];}();
...
PnlBrlyConMNFlight::DpchAppDo::DpchAppDo() :
			DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYCONMNFLIGHTDO)
		{
	ixVDo = 0;
};
...
void PnlBrlyConMNFlight::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlyConMNFlightDo"];}();
...
void PnlBrlyConMNFlight::DpchEngData::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngBrlyConMNFlightData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryBrlyConMNFlight::StatApp::writeJSON(me);
