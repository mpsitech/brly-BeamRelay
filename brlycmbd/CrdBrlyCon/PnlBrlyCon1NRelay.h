...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQCon1NRelay* rst = NULL, QryBrlyCon1NRelay::StatShr* statshrqry = NULL, QryBrlyCon1NRelay::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
