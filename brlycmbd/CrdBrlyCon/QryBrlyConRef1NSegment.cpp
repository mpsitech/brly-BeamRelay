...
void QryBrlyConRef1NSegment::rerun(
	...
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYSEGMOD_RETREUEQ, jref, Clstn::VecVJobmask::ALL, 0, false, VecBrlyVMSegmentRefTbl::CON, preRefCon);
};
...
bool QryBrlyConRef1NSegment::handleCallBrlyStubChgFromSelf(
			DbsBrly* dbsbrly
		) {
	bool retval = false;
