...
void DlgBrlyConNew::handleRequest(
	...
	if (req->ixVBasetype == ReqBrly::VecVBasetype::CMD) {
		...
		if ((req->sref == "mon") && (ixVSge == VecVSge::CALC2)) handleTimerWithSrefMonInSgeCalc2(dbsbrly);
	};
};
...
void DlgBrlyConNew::handleDpchAppDoDetButCreClick(
	...
	// IP handleDpchAppDoDetButCreClick --- INSERT
};

void DlgBrlyConNew::handleTimerWithSrefMonInSgeCalc2(
			DbsBrly* dbsbrly
		) {
