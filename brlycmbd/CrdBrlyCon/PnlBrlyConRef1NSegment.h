...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQConRef1NSegment* rst = NULL, QryBrlyConRef1NSegment::StatShr* statshrqry = NULL, QryBrlyConRef1NSegment::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
