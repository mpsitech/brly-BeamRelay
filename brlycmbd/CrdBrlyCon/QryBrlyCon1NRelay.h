...
public:
	QryBrlyCon1NRelay(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyCon1NRelay();
...
public:
	...
	BrlyQCon1NRelay* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyRlyMod_conEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
