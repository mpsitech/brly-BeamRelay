...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 150, const Sbecore::uint TcoStaWidth = 175, const Sbecore::uint TcoStoWidth = 175, const Sbecore::uint TcoLp0Width = 125, const Sbecore::uint TcoLp1Width = 125);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQConMNFlight* rst = NULL, QryBrlyConMNFlight::StatShr* statshrqry = NULL, QryBrlyConMNFlight::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyConMNFlight(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyConMNFlight();
