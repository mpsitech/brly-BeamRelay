...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQConMNFlight* rst = NULL, QryBrlyConMNFlight::StatShr* statshrqry = NULL, QryBrlyConMNFlight::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
