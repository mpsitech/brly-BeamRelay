...
public:
	...
	public:
		...
		static const Sbecore::uint TCOFLTWIDTH = 3;
		static const Sbecore::uint TCOCORWIDTH = 4;
		static const Sbecore::uint TCOSTAWIDTH = 5;
		static const Sbecore::uint TCOSTOWIDTH = 6;
		static const Sbecore::uint TCOMODWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoGrpWidth = 100, const Sbecore::uint TcoOwnWidth = 100, const Sbecore::uint TcoFltWidth = 225, const Sbecore::uint TcoCorWidth = 250, const Sbecore::uint TcoStaWidth = 175, const Sbecore::uint TcoStoWidth = 175, const Sbecore::uint TcoModWidth = 100);

	public:
		Sbecore::uint TcoGrpWidth;
		Sbecore::uint TcoOwnWidth;
		Sbecore::uint TcoFltWidth;
		Sbecore::uint TcoCorWidth;
		Sbecore::uint TcoStaWidth;
		Sbecore::uint TcoStoWidth;
		Sbecore::uint TcoModWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQConList* rst = NULL, QryBrlyConList::StatShr* statshrqry = NULL, QryBrlyConList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyConList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyConList();
