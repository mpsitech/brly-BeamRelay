...
public:
	QryBrlyConMapNode(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyConMapNode();
...
public:
	...
	BrlyQConMapNode* getRecByJnum(const Sbecore::uint jnum);
