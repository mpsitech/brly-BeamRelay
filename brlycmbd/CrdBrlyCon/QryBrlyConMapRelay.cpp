...
QryBrlyConMapRelay::QryBrlyConMapRelay(
	...
	xchg->addClstn(VecBrlyVCall::CALLBRLYSTUBCHG, jref, Clstn::VecVJobmask::SPEC, jref, false, Arg(), 0, Clstn::VecVJactype::LOCK);
...
bool QryBrlyConMapRelay::handleCallBrlyStubChgFromSelf(
			DbsBrly* dbsbrly
		) {
	bool retval = false;
