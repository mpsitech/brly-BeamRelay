...
public:
	QryBrlyConMNSegment(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyConMNSegment();
...
public:
	...
	BrlyQConMNSegment* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyConRsegMod_conEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
