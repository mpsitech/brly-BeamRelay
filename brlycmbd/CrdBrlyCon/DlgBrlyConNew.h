...
public:
	...
	/**
	  ...
	  */
	class ContInfCal : public Sbecore::Xmlio::Block {
	...
	/**
		...
		*/
	class StatShrCal : public Sbecore::Xmlio::Block {
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContIacDet* contiacdet = NULL, ContInf* continf = NULL, ContInfCal* continfcal = NULL, Sbecore::Xmlio::Feed* feedFDetPupMdl = NULL, Sbecore::Xmlio::Feed* feedFDetPupTtb = NULL, Sbecore::Xmlio::Feed* feedFDse = NULL, Sbecore::Xmlio::Feed* feedFSge = NULL, StatShr* statshr = NULL, StatShrCal* statshrcal = NULL, StatShrDet* statshrdet = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		Sbecore::Xmlio::Feed feedFDetPupMdl;
		Sbecore::Xmlio::Feed feedFDetPupTtb;
