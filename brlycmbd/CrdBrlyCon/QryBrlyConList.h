...
public:
	...
	public:
		...
		static const Sbecore::uint COR = 2;
		static const Sbecore::uint FLT = 3;
...
public:
	QryBrlyConList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyConList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const Sbecore::ubigint preGrp, const Sbecore::ubigint preOwn, const Sbecore::ubigint preFlt, const Sbecore::ubigint preCor, const int preSta, const bool addwhere);
	...
	BrlyQConList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallBrlyConMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
