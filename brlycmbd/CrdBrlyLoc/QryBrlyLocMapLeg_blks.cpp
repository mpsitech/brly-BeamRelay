...
void QryBrlyLocMapLeg::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryBrlyLocMapLeg::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryBrlyLocMapLeg"];}();
...
void QryBrlyLocMapLeg::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
