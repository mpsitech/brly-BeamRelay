...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocBgn1NLeg* rst = NULL, QryBrlyLocBgn1NLeg::StatShr* statshrqry = NULL, QryBrlyLocBgn1NLeg::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
