...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneMap = false, const bool initdoneBgn1NLeg = false, const bool initdoneEnd1NLeg = false, const bool initdoneEqp1NNode = false, const bool initdoneMNSegment = false, const bool initdoneMNFlight = false, const bool initdoneMNLeg = false, const bool initdoneVisOrgMNLocation = false, const bool initdoneProxOrgMNLocation = false, const bool initdoneEqpMNConnection = false);
