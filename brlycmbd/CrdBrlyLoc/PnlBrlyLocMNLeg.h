...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 250, const Sbecore::uint TcoLp0Width = 100, const Sbecore::uint TcoLp1Width = 100, const Sbecore::uint TcoLphWidth = 100, const Sbecore::uint TcoLthWidth = 100, const Sbecore::uint TcoXp0Width = 100, const Sbecore::uint TcoXp1Width = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocMNLeg* rst = NULL, QryBrlyLocMNLeg::StatShr* statshrqry = NULL, QryBrlyLocMNLeg::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyLocMNLeg(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyLocMNLeg();
