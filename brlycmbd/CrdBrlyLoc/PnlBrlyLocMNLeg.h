...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocMNLeg* rst = NULL, QryBrlyLocMNLeg::StatShr* statshrqry = NULL, QryBrlyLocMNLeg::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
