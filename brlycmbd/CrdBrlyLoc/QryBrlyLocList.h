...
public:
	...
	public:
		static const Sbecore::uint EQP = 1;
		static const Sbecore::uint REG = 2;
		static const Sbecore::uint TYP = 3;
		static const Sbecore::uint TIT = 4;
		static const Sbecore::uint ICA = 5;
...
public:
	QryBrlyLocList(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLocList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const std::string& preIca, const std::string& preTit, const Sbecore::uint preTyp, const Sbecore::ubigint preReg, const Sbecore::ubigint preEqp, const bool addwhere);
	...
	BrlyQLocList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyLocMod(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
