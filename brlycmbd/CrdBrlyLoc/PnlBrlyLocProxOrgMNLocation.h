...
public:
	...
	public:
		...
		static const Sbecore::uint TCODPHWIDTH = 2;

	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 200, const Sbecore::uint TcoDphWidth = 100);

	public:
		Sbecore::uint TcoMrefWidth;
		Sbecore::uint TcoDphWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocProxOrgMNLocation* rst = NULL, QryBrlyLocProxOrgMNLocation::StatShr* statshrqry = NULL, QryBrlyLocProxOrgMNLocation::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlyLocProxOrgMNLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlyLocProxOrgMNLocation();
