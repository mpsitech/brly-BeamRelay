...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocEnd1NLeg* rst = NULL, QryBrlyLocEnd1NLeg::StatShr* statshrqry = NULL, QryBrlyLocEnd1NLeg::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
