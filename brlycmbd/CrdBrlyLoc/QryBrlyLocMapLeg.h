...
public:
	QryBrlyLocMapLeg(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLocMapLeg();
...
public:
	...
	BrlyQLocMapLeg* getRecByJnum(const Sbecore::uint jnum);
