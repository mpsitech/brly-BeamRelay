...
public:
	QryBrlyLocEqp1NNode(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLocEqp1NNode();
...
public:
	...
	BrlyQLocEqp1NNode* getRecByJnum(const Sbecore::uint jnum);
