...
public:
	QryBrlyLocMapVisLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyLocMapVisLocation();
...
public:
	...
	BrlyQLocMapVisLocation* getRecByJnum(const Sbecore::uint jnum);
