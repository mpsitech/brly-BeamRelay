...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListBrlyQLocEqp1NNode* rst = NULL, QryBrlyLocEqp1NNode::StatShr* statshrqry = NULL, QryBrlyLocEqp1NNode::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
