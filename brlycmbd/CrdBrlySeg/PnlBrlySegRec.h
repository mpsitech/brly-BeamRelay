...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdonePre = false, const bool initdoneDetail = false, const bool initdoneOrgMNSegment = false, const bool initdoneMNLocation = false, const bool initdoneMNConnection = false);
