...
public:
	...
	public:
		...
		static const Sbecore::uint TCODP0WIDTH = 4;
		static const Sbecore::uint TCODP1WIDTH = 5;
		static const Sbecore::uint TCOOP0WIDTH = 6;
		static const Sbecore::uint TCOOP1WIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 100, const Sbecore::uint TcoStaWidth = 100, const Sbecore::uint TcoStoWidth = 100, const Sbecore::uint TcoDp0Width = 100, const Sbecore::uint TcoDp1Width = 100, const Sbecore::uint TcoOp0Width = 100, const Sbecore::uint TcoOp1Width = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQSegOrgMNSegment* rst = NULL, QryBrlySegOrgMNSegment::StatShr* statshrqry = NULL, QryBrlySegOrgMNSegment::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlySegOrgMNSegment(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlySegOrgMNSegment();
