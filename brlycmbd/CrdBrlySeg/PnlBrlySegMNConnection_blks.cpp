...
void PnlBrlySegMNConnection::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlySegMNConnection::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlBrlySegMNConnection::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlBrlySegMNConnection::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacBrlySegMNConnection"];}();
...
void PnlBrlySegMNConnection::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlBrlySegMNConnection::Tag::writeJSON(
...
void PnlBrlySegMNConnection::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlySegMNConnectionData"];}();
...
void PnlBrlySegMNConnection::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppBrlySegMNConnectionDo"];}();
...
void PnlBrlySegMNConnection::DpchEngData::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngBrlySegMNConnectionData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryBrlySegMNConnection::StatApp::writeJSON(me);
