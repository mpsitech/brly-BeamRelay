...
public:
	QryBrlySegOrgMNSegment(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlySegOrgMNSegment();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const int preTime, const double prePhi, const bool addwhere);
	...
	BrlyQSegOrgMNSegment* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlySegRsegMod_osgEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
