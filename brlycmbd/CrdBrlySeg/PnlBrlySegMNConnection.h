...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoMrefWidth = 100, const Sbecore::uint TcoStaWidth = 100, const Sbecore::uint TcoStoWidth = 100, const Sbecore::uint TcoLp0Width = 100, const Sbecore::uint TcoLp1Width = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQSegMNConnection* rst = NULL, QryBrlySegMNConnection::StatShr* statshrqry = NULL, QryBrlySegMNConnection::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlBrlySegMNConnection(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~PnlBrlySegMNConnection();
