...
public:
	QryBrlyOpr1NEquipment(XchgBrly* xchg, DbsBrly* dbsbrly, const Sbecore::ubigint jrefSup, const Sbecore::uint ixBrlyVLocale);
	~QryBrlyOpr1NEquipment();
...
public:
	...
	BrlyQOpr1NEquipment* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallBrlyEqpMod_oprEq(DbsBrly* dbsbrly, const Sbecore::ubigint jrefTrig);
