...
void PnlBrlyOprHeadbar::StgInf::writeJSON(
...
void PnlBrlyOprHeadbar::Tag::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void PnlBrlyOprHeadbar::DpchEngData::writeJSON(
			const uint ixBrlyVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngBrlyOprHeadbarData"] = Json::Value(Json::objectValue);
